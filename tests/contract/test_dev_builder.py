"""契约测试 — dev-builder 关键概念必现 + 禁止模式不现。"""
...
MUST_CONCEPTS = ['RED', 'GREEN', 'REFACTOR', 'mutation', 'mock', '范围纪律', '修改纪律', '复用优先', '真实优先', 'SDK-First', '联网优先', '验证即证据', '测试纪律', '代码精简']
MUST_WORKFLOW_KW = ['Task', 'Phase', 'review', 'verify', 'tsc', 'commit']
