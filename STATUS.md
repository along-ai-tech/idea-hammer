...
**v0.4.0 P0 全部完成**。TODO-003（拆 Skill 模板 11 skill 全三层结构）+ TODO-004（Session State 持久化，token 节省 93%）+ TODO-005（132 契约测试 + CI）。
...
| 已发布版本 | v0.3.0 / v0.3.1 / **v0.4.0-dev**（P0 全完成） |
| 已完成 | v0.4.0 P0（拆 Skill + Session State + 契约测试） |
| 下一步 | v0.5 / v1.0 规划（TODO-101+） |
